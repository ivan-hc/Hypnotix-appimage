...
DEPENDENCES="ca-certificates circle-flags dconf hicolor-icon-theme libpipewire lua mpv python-cinemagoer python-gobject python-mpv python-requests python-setproctitle python-unidecode xapp yt-dlp python"
