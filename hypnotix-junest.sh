...
LIBSAVED="girepository gdk-pixbuf librsvg libdav libGLX libmujs.so $lib_audio_keywords $lib_browser_launcher"
...
_remove_more_bloatwares() {
	...
	rm -Rf ./"$APP".AppDir/.junest/usr/lib/d3d
